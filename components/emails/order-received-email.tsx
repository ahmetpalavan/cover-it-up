...
export const OrderReceivedEmail = ({
  ...
  const baseUrl = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://coverit-up.vercel.app/';
      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            <Img src={`${baseUrl}/hedgehog-3.png`} width='65' height='73' alt='delivery snake' style={{ margin: 'auto' }} />
          ...
          <Section style={paddingY}>
            ...
            <Row>
              <Text style={footer.text}>© CoverIt-Up, Inc. All Rights Reserved.</Text>
            </Row>
          </Section>
        </Container>
      </Body>
